...
{
    public static class PhoxiFunc
    {

        public static PhoXiDeviceInformation[] _deviceList;
        public static PhoXi _phoXiDevice;
        public static PhoXiFactory _factory;
        public static Frame _sampleFrame;
        public const string FileCameraFolder = @"";
        public const string OutputFolder = @"C:\PhoxiAPI";

        static PhoxiFunc()
        {
            _factory = new PhoXiFactory();
            _deviceList = null;
            MyLib.CreateFolder(OutputFolder);
        }

        public static void GetAvailableDevicesExample()
        {
        ...
        public static void LogListDevices()
        {
        ...
        public static void ConnectPhoXiDeviceBySerialExample(string hardwareIdentification)
        {
            ...
            if (_phoXiDevice)
            {
                ...
                MyLib.showDlgInfo($"Connected to {hardwareIdentification}");
            }
            else
            {
                Console.WriteLine("Connection to the device " + hardwareIdentification + " was Unsuccessful!");
                MyLib.showDlgInfo($"Can't connect to {hardwareIdentification}");
            }
        }

        public static void ConnectPhoXiDeviceByPhoXiDeviceInformationEntryExample(int index)
        {
        ...
        public static void ConnectFirstAttachedPhoXiDeviceExample()
        {
        ...
        public static void ConnectPhoXiFileCameraExample(string FileCameraHWIdentification, string[] FilePaths)
        {
            var fileCameraName = _factory.AttachFileCamera(FileCameraHWIdentification, FilePaths);

            if (fileCameraName == string.Empty)
            {
                Console.WriteLine("Could not create file camera! Check whether praw files are in the specified folder: {0}", FilePaths[0]);
                return;
            }
        ...
        public static void DisconnectExample()
        {
        ...
        public static void BasicDeviceInfo()
        {
            //Check if the device is connected
            if (!_phoXiDevice)
            {
        ...
        public static void FreerunExample()
        {
            //Check if the device is connected
        ...
        public static void SoftwareTriggerExample()
        {
            //Check if the device is connected
            if (_phoXiDevice == null || !_phoXiDevice.isConnected())
            {
            ...
            Console.WriteLine("Triggering the 1-st frame");
            ...
            stopwatch.Stop();
            Console.WriteLine("Frame was triggered, Frame Id: {0}, time process = {1} ms", FrameID, stopwatch.ElapsedMilliseconds);
            ...
            if (myFrame != null)
            {
                ...
                PrintFrameData(myFrame);
                stopwatch.Stop();
                Console.WriteLine("Time print infor = {0} ms", stopwatch.ElapsedMilliseconds);
            ...
            stopwatch.Restart();
            framePointCloudData = _sampleFrame.PointCloud.GetDataCopyXYZXYZ();
            stopwatch.Stop();
            Console.WriteLine("Time copy data = {0} ms", stopwatch.ElapsedMilliseconds);

            stopwatch.Restart();
            getPointCloud(0, 0);
            getPointCloud(205, 498);
            getPointCloud(498, 205);
            getPointCloud(299, 514);
            Console.WriteLine("---------");
            getPointCloud(80, 428);
            getPointCloud(81, 648);
            getPointCloud(876, 427);

            Console.WriteLine("----new-----");
            getPointCloud(428, 80);
            getPointCloud(648, 81);
            getPointCloud(427, 876);
            Console.WriteLine("----end-----");
            
            stopwatch.Stop();
            Console.WriteLine("Time mapping point= {0} ms", stopwatch.ElapsedMilliseconds);


        }

        static float[] framePointCloudData = null;
        // Generic point clound calculus based on C# data structures
        static float[] getPointCloud(int y, int x)
        {
            const int channels = 3;
            int index = channels * (y * _sampleFrame.PointCloud.Size.Width + x);
            float[] data = new float[3];

            data[0] = framePointCloudData[index + 0];
            data[1] = framePointCloudData[index + 1];
            data[2] = framePointCloudData[index + 2];

            Console.WriteLine($"at x,y = ({x},{y}), point cloud = ({data[0]},{data[1]},{data[2]})");
            return data;
        }
        ...
        public static void ChangeSettingsExample()
        {
            //Check if the device is connected
            if (_phoXiDevice == null || !_phoXiDevice.isConnected())
            {
        ...
        public static void ChangeProfileExample()
        {
        ...
        /*unsafe*/
        public static void DataHandlingExample()
        {
        ...
        #region 
        public static void PrintFrameInfo(Frame frame)
        {
        ...
        public static void PrintFrameData(Frame frame)
        {
            if (frame.Empty())
            {
        ...
        public static void PrintCapturingSettings(PhoXiCapturingSettings capturingSettings)
        {
        ...
        public static void PrintProcessingSettings(PhoXiProcessingSettings processingSettings)
        {
        ...
        public static void PrintCoordinatesSettings(PhoXiCoordinatesSettings coordinatesSettings)
        {
        ...
        public static void PrintCalibrationSettings(PhoXiCalibrationSettings calibrationSettings, string source)
        {
        ...
        public static void PrintCoordinateTransformation(PhoXiCoordinateTransformation transformation)
        {
            PrintMatrix("RotationMatrix", transformation.Rotation);
            PrintVector("TranslationVector", transformation.Translation);
        }

        public static void PrintAdditionalCalibrationSettings(PhoXiAdditionalCameraCalibration calibrationSettings, string source)
        {
        ...
        public static void PrintResolution(PhoXiSize resolution)
        {
        ...
        public static void PrintScanningVolume(PhoXiScanningVolume scanningVolume)
        {
        ...
        public static void PrintVector(string name, Point3_64f vector)
        {
        ...
        public static void PrintMatrix(string name, CameraMatrix64f matrix)
        {
            if (matrix.Empty())
            {
        ...
        public static void PrintMatrix(string name, RotationMatrix64f matrix)
        {
            if (matrix.Empty())
            {
                Console.WriteLine("{0}: [empty]", name);
